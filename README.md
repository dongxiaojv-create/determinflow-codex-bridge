...
**0.3.0 预览版：仅 macOS Apple Silicon。** 基于 DeterminFlow Desktop 1.1.0 / Core `9db9d98c` 的扩展接口，固定官方 Codex CLI `0.153.4`。其他 Core、CLI 版本、Intel Mac、Windows、Linux 尚未验收。此项目不是 OpenAI 或 DeterminFlow 官方插件。
...
- 本仓库不包含 Tai-Xu 写作界面、Portal 改写接口、用户书库、私有 Core 源码或实验目录。
